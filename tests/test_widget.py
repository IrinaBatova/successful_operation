...
# С применением фикстур
def test_get_date_1(data, formatted_date):
    assert get_date(data) == formatted_date

# С применением параметризации
@pytest.mark.parametrize("data, formatted_date", [("", "Вы ничего не ввели"), ("0000-00-00T02:26:18.671407", "00.00.0000")])
def test_get_date_2(data, formatted_date):
    assert get_date(data) == formatted_date