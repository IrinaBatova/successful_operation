...
def test_currency_conversion_1(mock_request):
    ...
    assert result == 630982.057672, "Конвертация валюты не прошла как ожидалось" # Проверяем, что функция вернула ожидаемый результат
...
def test_currency_conversion_2():
