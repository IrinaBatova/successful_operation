...
@pytest.fixture
def transactions_utils_usd() -> dict:  # Входные данные
    ...
    return transactions_utils_usd

# Тестирование модуля generators.py

# Фикстуры для тестирования функции filter_by_currency


@pytest.fixture
def transactions() -> list:  # Входные данные
    transactions = [
        {
            "id": 939719570,
            "state": "EXECUTED",
