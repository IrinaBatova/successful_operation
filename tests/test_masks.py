...
@pytest.mark.parametrize("card_number, mask_card_number", [(123, "Введено не 16 цифр" ),
                                                           (12345678912345678, "Введено не 16 цифр"),
                                                           (-123456, "Введено число < 0")])
...
# С применением параметризации
@pytest.mark.parametrize("account_number, masked", [(123456789, "** 6789" ),
                                                    (12345, "Введено меньше 6 цифр"),
                                                    (-123456, "Введено число < 0")])
